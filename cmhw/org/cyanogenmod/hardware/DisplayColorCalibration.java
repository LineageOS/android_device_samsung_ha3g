...
public class DisplayColorCalibration {
    ...
    private static final String RED_FILE = "/sys/devices/virtual/misc/mdnie/r_adj";
    private static final String GREEN_FILE = "/sys/devices/virtual/misc/mdnie/g_adj";
    private static final String BLUE_FILE = "/sys/devices/virtual/misc/mdnie/b_adj";

    private static final int MIN = 1;
    private static final int MAX = 255;

    public static boolean isSupported() {
        return FileUtils.isFileWritable(RED_FILE);
    }
